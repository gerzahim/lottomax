...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-04-2013 a las 06:07:59
...
CREATE TABLE IF NOT EXISTS `taquillas` (
  ...
  `numero_taquilla` int(11) NOT NULL,
  `status` int(11) NOT NULL COMMENT ' 0=Inactivo, 1=Activo',
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Ticket Transaccional' AUTO_INCREMENT=14 ;
