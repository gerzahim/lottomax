...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-04-2013 a las 23:56:35
...
(13, 1, 0, '001', '2013-04-29 00:00:00');
...
('20130329120004', '2000194991', '2013-04-29 02:03:00', 2, 60.00, 1, 0, 0);
...
CREATE TABLE IF NOT EXISTS `ticket_transaccional` (
  ...
  KEY `id_sorteo` (`id_sorteo`),
  KEY `id_tipo_jugada` (`id_tipo_jugada`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Ticket Transaccional' AUTO_INCREMENT=3 ;
