...
--
-- Servidor: localhost
-- Tiempo de generación: 04-03-2014 a las 14:00:51
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Detalle ticket' AUTO_INCREMENT=78459 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='guarda numeros incompletos y agotados' AUTO_INCREMENT=707 ;
...
CREATE TABLE IF NOT EXISTS `numeros_jugados` (
  ...
  KEY `id_tipo_jugada` (`id_tipo_jugada`),
  KEY `id_zodiacal` (`id_zodiacal`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=14046 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1493 ;
...
CREATE TABLE IF NOT EXISTS `ticket_transaccional` (
  ...
  KEY `id_sorteo` (`id_sorteo`),
  KEY `id_tipo_jugada` (`id_tipo_jugada`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Ticket Transaccional' AUTO_INCREMENT=21023 ;
...
(154, 6, 1, '2014-03-04 07:14:01'),
(155, 4, 3, '2014-03-04 07:30:18'),
(156, 5, 2, '2014-03-04 08:05:23'),
(157, 1, 4, '2014-03-04 09:33:16');
