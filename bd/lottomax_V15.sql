...
--
-- Servidor: localhost
-- Tiempo de generación: 13-03-2014 a las 20:10:24
...
--
CREATE DATABASE IF NOT EXISTS `lottomax` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;
USE `lottomax`;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Detalle ticket' AUTO_INCREMENT=124587 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=2789 ;
