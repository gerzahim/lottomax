<?php
/**
 * Archivo del controlador para modulo Cupos Especiales de Numeros
 * @package cCupos_Especiales.php
...
// Vista asignada
$obj_xtpl->assign_file('contenido', $obj_config->GetVar('ruta_vista').'cupos_especiales'.$obj_config->GetVar('ext_vista'));
