...
if($result= mysql_query($sql,$conexion_abajo)){
	...
	while ($row = mysql_fetch_array($result)){
		...
		$usuario_taquilla=0;
		$consulta_arriba_ticket.="('".$row['id_ticket']."','".$row['serial']."','".$row['fecha_hora']."',".$row['taquilla'].",'".$row['total_ticket']."',".$row['id_usuario'].",".$row['premiado'].",".$row['pagado'].",".$row['total_premiado'].",".$row['status'].",'".$row['fecha_hora_anulacion']."',".$row['taquilla_anulacion'].",1,".$row['verificado'].",".$row['impreso'].",'".$row['fecha_hora_pagado']."',".$usuario_taquilla.",".$usuario_taquilla."),";   
